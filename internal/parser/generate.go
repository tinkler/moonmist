...
func GenerateChiRoutes(path string, pkg *Package, dep map[string]*Package) error {
	...
	{
		f.WriteString(fmt.Sprintln("// Code generated by github.com/tinkler/moonmist; DO NOT EDIT."))
		f.WriteString(fmt.Sprintln("package route"))

		debugPathFile.WriteString(fmt.Sprintln("// Code generated by github.com/tinkler/moonmist; DO NOT EDIT."))
...
func GenerateProtoFile(path string, root string, goModule string, pkg *Package, dep map[string]*Package) error {
	...
	protoFile.WriteString(fmt.Sprintln("// Code generated by github.com/tinkler/moonmist; DO NOT EDIT."))
	protoFile.WriteString(fmt.Sprintln("syntax = \"proto3\";"))
	protoFile.WriteString(fmt.Sprintf("option go_package = \"%s/%s/v1;%s_v1\";\n", goModule, pkg.Name, pkg.Name))
	protoFile.WriteString(fmt.Sprintln("option java_multiple_files = true;"))
	protoFile.WriteString(fmt.Sprintf("option java_package = \"ink.sfs.tinkler.moonmist.%s.v1\";\n", pkg.Name))
...
func GenerateGsrv(path string, goModule string, pkg *Package, dep map[string]*Package) error {
	...
	if hasMethods {
		f.WriteString(fmt.Sprintln("\tmrz \"github.com/tinkler/moonmist/mrz/v1\""))
	}
	f.WriteString(fmt.Sprintf("\t\"%s\"\n", pkg.ImportsMap[pkg.Name]))
	f.WriteString(fmt.Sprintf("\tpb_%s_v1 \"%s/%s/v1\"\n", pkg.Name, goModule, pkg.Name))
	...
	if hasStreamMethods {
		f.WriteString(fmt.Sprintln("\t\"github.com/tinkler/moonmist/pkg/jsonz/cjson\""))
	}
	...
	for _, importName := range pkg.Imports {
		if _, used := usedDepStruct[importName]; used {
			...
			if streamModels[importName] {
				f.WriteString(fmt.Sprintf("\tpb_%s_v1 \"%s/%s/v1\"\n", importName, goModule, importName))
			}
		}
	}
...
func GenerateTSAngularDelonCode(path string, pkg *Package, dep map[string]*Package) error {
	...
	{
		doNotEdit := "// Code generated by github.com/tinkler/moonmist; DO NOT EDIT."
...
func GenerateDartCode(path string, pkg *Package, dep map[string]*Package) error {
	...
	{
		f.WriteString(fmt.Sprintln("// Code generated by github.com/tinkler/moonmist; DO NOT EDIT."))
		f.WriteString(fmt.Sprintln("import 'package:dio/dio.dart';"))
	}
	var (
		usedDepStruct = make(map[string]map[string]bool)
	)
	...
	t := template.Must(template.New("model").Funcs(template.FuncMap{
		"toType": func(goType string) string {
			...
			if strings.HasPrefix(goType, "[]") {
				...
				if typ := dartTypeMap[typ]; typ != "" {
					return fmt.Sprintf(resTypePre+"%s"+resTypeSuf, typ)
				}
					...
					if nameSplice := strings.Split(typ, "."); len(nameSplice) > 1 {
						if pkg, isDep := dep[nameSplice[0]]; isDep {
							if FindStruct(pkg, nameSplice[1]) != nil {
								return fmt.Sprintf(resTypePre+"%s"+resTypeSuf, "$"+pkg.Name+"."+nameSplice[1])
							}
						}
					}
				}
		...
		"fromJson": func(goType string, name string) string {
			...
			if strings.HasPrefix(goType, "[]") {
				goType = strings.TrimPrefix(goType, "[]")
				if typ := dartTypeMap[goType]; typ != "" {
					return fmt.Sprintf(" == null ? null : (json[\"%s\"] as List<dynamic>).map((e) => e as %s).toList()", name, typ)
				}
				if s := FindStruct(pkg, goType); s != nil {
					return fmt.Sprintf(" == null ? null : (json[\"%s\"] as List<dynamic>).map((e) => %s.fromJson(e)).toList()", name, goType)
				}
				if dep != nil {
					if nameSplice := strings.Split(goType, "."); len(nameSplice) > 1 {
						if pkg, isDep := dep[nameSplice[0]]; isDep {
							if FindStruct(pkg, nameSplice[1]) != nil {
								return fmt.Sprintf(" == null ? null : (json[\"%s\"] as List<dynamic>).map((e) => $"+"%s."+nameSplice[1]+".fromJson(e)).toList()", name, pkg.Name)
							}
						}
					}
				}
				return fmt.Sprintf(" == null ? null : (json[\"%s\"] as List<dynamic>).map((e) => %s.fromJson(e)).toList()", name, strings.TrimPrefix(goType, "[]"))
			}
			if s := FindStruct(pkg, goType); s != nil {
				return fmt.Sprintf(" == null ? null : %[1]s.fromJson(json[\"%[2]s\"])", goType, name)
			}
			if dep != nil {
				if nameSplice := strings.Split(goType, "."); len(nameSplice) > 1 {
					if pkg, isDep := dep[nameSplice[0]]; isDep {
						if FindStruct(pkg, nameSplice[1]) != nil {
							return fmt.Sprintf(" == null ? null : %[1]s.fromJson(json[\"%[2]s\"])", "$"+pkg.Name+"."+nameSplice[1], name)
						}
					}
				}
			}
	...
	if dartBin, err := exec.LookPath("dart"); err == nil {
		if err := exec.Command(dartBin, "format", sourcePath).Run(); err != nil {
			mlog.Error(err)
		}
	}
...
class {{.Name}} {
	...
	const {{.Name}}(
		{
		{{range .Fields}}required this.{{.Name | toCamel}},
		{{end}}
		});

	factory {{.Name}}.empty(
		{
			{{range .Fields}}{{.Type | toType}}? {{.Name | toCamel}},
			{{end}}
		}) {
		return {{.Name}}(
	...
	{{.Name}} copyWith(
		...
		return {{.Name}}(
			{{range .Fields}}{{.Name | toCamel}}: {{.Name | toCamel}} ?? this.{{.Name | toCamel}},
			{{end}}
		);
	}
	...
	factory {{.Name}}.fromJson(Map<String, dynamic> json) {
		return {{.Name}}.empty({{range .Fields}}
	...
	{{range .Comments}}/// {{.}}
	{{end}}{{end}}Future<{{if .Rets}}({{$struct.Name}}, {{(index .Rets 0).Type | toType}}){{else}}{{$struct.Name}}{{end}}> {{.Name | toCamel}}(
...
// swift template
var swiftModelTemplate = `// Code generated by github.com/tinkler/moonmist; DO NOT EDIT.
{{range .Structs}}
struct {{.Name}} {
	{{range .Fields}}
